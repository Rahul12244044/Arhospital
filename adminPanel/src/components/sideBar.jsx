        ...
        <div className="min-h-screen bg-white">
            {aToken && (
                <ul className="text-[#515151] mt-5">
                    ...
                    <NavLink className={({isActive}) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive?"bg-[#F2F3FF] border-r-4 border-blue-500":""}`} to={"/add-doctors"}>
            ...
            {dToken && (
                <ul className="text-[#515151] mt-5">
                    ...
                    <NavLink className={({isActive}) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive?"bg-[#F2F3FF] border-r-4 border-blue-500":""}`} to={"/doctor-feedback"}>
                        <img src={assets.feedback_icon || assets.people_icon} alt=""/> {/* Add feedback icon to assets or use people icon */}
